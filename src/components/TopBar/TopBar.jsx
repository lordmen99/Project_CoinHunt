...
import {AvTimer, Add, ShowChart, ContactSupportOutlined} from '@material-ui/icons'
...
const menu = (
    ...
    <a onClick={e => window.location.href="/Account_Watchlist"}>Account Watchlist</a>
    </Menu.Item>
    ...
    <Menu.Item key="4" icon={<ContactSupportOutlined style={{fontSize:"medium"}} />}>
        ...
        <div className="topBar">
            ...
            <div className="leftContainer">
                ...
                <div className="logoContainer">
                    ...
                    <a onClick={e => window.location.href = '/' }><img src={logo} alt="coinhunt.png" className="main_logo"/></a>
            ...
            <div className="rightContainer">
                ...
                <div className="menuContainer">
                    ...
                    <ul>
                        ...
                        <Button  style={{ backgroundColor: "green",border:"none",color:"white" }} className="ant-dropdown-link" onClick={e => e.preventDefault()}>Main Menu<DownOutlined /></Button>
                        </Dropdown>
                        ...
                        <li className="signupBtn"><Button type="default" onClick={e => window.location.href="/Signup"}>Signup</Button></li>
                        <li className="loginBtn"><Button  type="primary" onClick={e => window.location.href="/login"}>Login</Button></li>
